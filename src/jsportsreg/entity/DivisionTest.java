...
public class DivisionTest {
	...
	public void testDivision() {
		...
		assertEquals("Division Test 1: Division Description","T-Ball: 5 & 6 yoa",instance0.getDivisionDescription());
		assertEquals("Division Test 1: Division Name","5 & 6 years old",instance0.getDivisionName());
